...
describe('App', () => {
  xit('Contains the compiled JavaScript', async () => {
...
describe('Game', () => {
  ...
  describe('Game', () => {
    xit('Initializes with two players', async () => {
    ...
    xit('Starts the game with a random player', async () => {
      Math.random = () => 0.4
  ...
  describe('nextPlayer', () => {
    xit('Sets the current player to be whoever it is not', async () => {
      Math.random = () => 0.4
